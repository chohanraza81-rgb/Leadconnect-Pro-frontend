...
import { Trash2, Search, Copy, Phone, Loader2, ExternalLink } from "lucide-react";
      ...
      <div className="glass-card p-6 space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <div>
            ...
            <Input placeholder="e.g. CEO" value={jobTitle} onChange={e => setJobTitle(e.target.value)} className="bg-white/5 border-white/10" />
          </div>
